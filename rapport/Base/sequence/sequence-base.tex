...
\begin{figure}[h]
\centering
\includegraphics[width = 0.9\textwidth]{Base/sequence/img/common/répondre aux notifications.png}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width = 1\textwidth]{Base/sequence/img/common/Visualisation des données de consommations.png}
\end{figure}
