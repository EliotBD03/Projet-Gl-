...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/Gérer les données.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/Gérer les langues.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/Modifier son mot de passe.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/Répondre aux notifications.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/S'authentifier.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/Visualisation des données de consommations.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/Voir les contrats.pdf}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 1\textwidth]{sequence/common/Voir notifications.pdf}
\end{figure}
